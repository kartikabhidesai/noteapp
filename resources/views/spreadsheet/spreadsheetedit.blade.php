            ...
            <article class="c-stage">
                <div class="c-stage__header o-media u-justify-start">
                    ...
                    <div class="c-stage__panel u-p-medium">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="c-field u-mb-small">
                                    ...
                                    <input class="c-input" name="noteTitle" id="noteTitle" placeholder="Enter Sheet Title" type="text" value="{{ $sheetdata[0]['title'] }}">
                        ...
                        <div class="row">
                            <div class="col-lg-3">
                                <input class="c-btn c-btn--info c-btn--fullwidth" id="addsheet" value="Edit Sheet" type="button">
                            </div>
                        </div>
                    </div>
