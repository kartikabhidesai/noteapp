                             ...
                             <table class="c-table" id="datatable">
                                <caption class="c-table__title">
                                   <div class="c-card__header--transparent o-line">
                                       <h4 class="c-card__title"><b>Spread Sheet List</b></h4>
                                        <div class="c-card__meta">
                                            <a href="{{ route("add-sheet")}}"><i class="fa fa-plus fa-2x" aria-hidden="true"></i></a>
                                        </div>
                                    </div>
                                </caption>
                                ...
                                <tbody>
                                    ...
                                    @endphp
                                        <tr class="c-table__row">
                                            ...
                                            <td class="c-table__cell">{{ $sheetlist[$i]['title'] }}</td>
                                            
                                            <td class="c-table__cell">{{ $sheetlist[$i]['created_at'] }}</td>
                                            <td class="c-table__cell">{{ $sheetlist[$i]['ip_address'] }}</td>
                                            <td class="c-table__cell">
                                                <div class="c-dropdown dropdown">
                                                    ...
                                                    <div class="c-dropdown__menu dropdown-menu" aria-labelledby="dropdownMenuButton10">
                                                        <a class="c-dropdown__item dropdown-item" href="{{ route('edit-sheet',$id) }}">Edit</a>
                                                        <a class="c-dropdown__item dropdown-item" href="{{ route("view-sheet",$id) }}">View</a>
